...
@onready var office = $".."
@onready var sprite_camera_ardent = $"../UiPc/CamFeed/Ardent"
@onready var animation_camera_static = $"../UiPc/CamFeed/CameraStatic"
@onready var sound_camera_buzz = $"../CamBuzzSound"
